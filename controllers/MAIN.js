    ...
    init: (app, db) => {
        ...
        app.get("/user-sponsorship/1", async (req, res) => {
            ...
            if (ad) {
                ...
                res.render("userads/userad1", {
                    ...(await db.getBlankRenderObject()),
                    adimg: `https://www.rbx2016.nl/asset?id=${ad.internalId}`,
                    adurl: `https://www.rbx2016.nl/redirect2?id=${ad.assetid}&ref=${ad.id}`,
                    adtitle: ad.desc
                });
            } else {
                res.render("userads/userad1", {
        ...
        */
                ...
                for (let i = 0; i < assets.length; i++) {
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="name-col">
                                <a class="title"
                                    href="https://www.rbx2016.nl/library/${asset.id}">${name}</a>
                                <table class="details-table">
                                    <tbody>
                                        <tr>
                                            <td class="item-date">
        ...
        app.get("/templates/userads", db.requireAuth, async (req, res) => {
            res.render("userads", await db.getRenderObject(req.user));
        });
        ...
        app.get("/build/upload", db.requireAuth, async (req, res) => {
            ...
            <div id="upload-fee-item-result-success" class="status-confirm ${isUploaded ? "" : "hidden"}">
                ...
                formData = `<div class="form-row">Did you use the template? If not, <a target="_blank" href="https://www.rbx2016.nl/templates/userads">download it here</a>.</div>
                <div class="form-row">
                    <label for="file">Find your image:</label>
                    <input id="file" type="file" accept="image/png,image/jpeg" name="file" tabindex="1">
                    <span id="file-error" class="error"></span>
...
<ul class="hlist game-cards ">`;
        ...
        async function getGamesT1(userid) {
            ...
            for (let i = 0; i < games.length; i++) {
                ...
                data-developerstats-url="https://create.rbx2016.nl/creations/game/{game.gameid}/stats">
                <tr>
                    <td class="image-col">
        ...
        app.get("/games/:gameid/:gamename", db.requireAuth, async (req, res) => {
            ...
            for (let i = 0; i < gamepasses.length; i++) {
                ...
                <div class="store-card">
                    <a href="https://www.rbx2016.nl/game-pass/${gamepass.id}" class="gear-passes-asset"><img class="" src="https://thumbnails.rbx2016.nl/v1/thumb?id=${gamepass.id}"></a>
        ...
        app.get("/users/profile/playergames-json", async (req, res) => {
            ...
            res.json({
                ...
                "GamePageResources": {
                    ...
                    "HeadingExperimentalMode": "Games Mode Games",
