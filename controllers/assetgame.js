    ...
    init: (app, db) => {
        ...
        app.get("/asset", db.requireAuth2, async (req, res) => {
            ...
            if (id0[0].startsWith("r") && db.getSiteConfig().backend.robloxAssetsUsingR == true) {
                res.redirect("https://assetdelivery.rbx2016.tk/v1/asset/?id=" + parseInt(id0[0].substring(1)).toString());
                return;
            }
            ...
            if (asset && !asset.deleted && (asset.approvedBy != 0 || (user && (asset.creatorid == user.userid || user.isAdmin || user.isMod)))){
                ...
                if (fs.existsSync(fp)) {
                    ...
                    res.redirect("https://assetdelivery.rbx2016.tk/v1/asset/?id=" + id);
                    // res.sendStatus(404);
                }
            }else{
        ...
        app.get("/asset/BodyColors.ashx", (req, res) => {
            ...
            <roblox xmlns:xmime="http://www.w3.org/2005/05/xmlmime" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="http://www.rbx2016.tk/roblox.xsd" version="4">
                ...
                <Item class="BodyColors">
                    <Properties>
                        <int name="HeadColor">1002</int>
                        <int name="LeftArmColor">1002</int>
                        <int name="LeftLegColor">1002</int>
                        <string name="Name">Body Colors</string>
                        <int name="RightArmColor">1002</int>
                        <int name="RightLegColor">1002</int>
                        <int name="TorsoColor">1002</int>
