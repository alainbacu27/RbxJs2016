            ...
            if (game.isPublic || game.port == 0) {
                ...
                res.json({
                    ...
                    "settings": {
                        ...
                        "CharacterAppearance": "https://api.r_2016.com/v1.1/avatar-fetch/?placeId=" + game.gameid.toString() + "&userId=" + req.user.userid.toString(),
                        "ClientTicket": "2022-06-01T20:30:45.3258937Z;t;6",
                        "GameId": "9bfd3e17-ffdb-cbce-5de5-a8f106b3bb72",
                        "PlaceId": game.gameid,
                        "BaseUrl": "http://gamejoin.r_2016.com/",
                        "ChatStyle": "Classic",
        ...
        app.post("/v1/join-game", db.requireAuth2, async (req, res) => {
            ...
            res.json({
                ...
                "joinScript": {
                    ...
                    "DirectServerReturn": true,
                    "PingUrl": "https://assetgame.r_2016.com/Game/ClientPresence.ashx?version=old&PlaceID=" + game.gameid.toString() + "&GameID=aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa&UserID=" + req.user.userid.toString(),
                    "PingInterval": 120,
                    "UserName": req.user.username,
                    "DisplayName": req.user.username,
                    "SeleniumTestMode": false,
