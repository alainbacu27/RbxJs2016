            ...
            if (game.isPublic || game.port == 0) {
                ...
                res.json({
                    ...
                    "settings": {
                        ...
                        "CharacterAppearance": "https://api.rbx2016.tk/v1.1/avatar-fetch/?placeId=" + game.gameid.toString() + "&userId=" + req.user.userid.toString(),
                        "ClientTicket": "2022-06-01T20:30:45.3258937Z;t;6",
                        "GameId": "9bfd3e17-ffdb-cbce-5de5-a8f106b3bb72",
                        "PlaceId": game.gameid,
                        "BaseUrl": "http://gamejoin.rbx2016.tk/",
                        "ChatStyle": "Classic",
        ...
        app.post("/v1/join-game", db.requireAuth2, async (req, res) => {
            ...
            res.json({
                ...
                "joinScript": {
                    ...
                    "DirectServerReturn": true,
                    "PingUrl": "https://assetgame.rbx2016.tk/Game/ClientPresence.ashx?version=old&PlaceID=" + game.gameid.toString() + "&GameID=aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa&UserID=" + req.user.userid.toString(),
                    "PingInterval": 120,
                    "UserName": req.user.username,
                    "DisplayName": req.user.username,
                    "SeleniumTestMode": false,
